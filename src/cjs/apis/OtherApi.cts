...
export class OtherApi extends runtime.BaseAPI {
     ...
     * solved.ac 통계 가져오기
     */
    async getSiteStatisticsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SiteStatistics>> {
     ...
     * solved.ac 통계 가져오기
     */
    async getSiteStatistics(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SiteStatistics> {
