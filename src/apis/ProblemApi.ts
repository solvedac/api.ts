...
export class ProblemApi extends runtime.BaseAPI {
     ...
     * CLASS별 문제 수 가져오기
     */
    async getClassProblemCountRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<InlineResponse2002>>> {
     ...
     * CLASS별 문제 수 가져오기
     */
    async getClassProblemCount(initOverrides?: RequestInit): Promise<Array<InlineResponse2002>> {
     ...
     * 수준별 문제 수 가져오기
     */
    async getProblemLevelRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<InlineResponse2003>>> {
        const queryParameters: any = {};
     ...
     * 수준별 문제 수 가져오기
     */
    async getProblemLevel(initOverrides?: RequestInit): Promise<Array<InlineResponse2003>> {
