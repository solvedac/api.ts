...
export class UserApi extends runtime.BaseAPI {
     ...
     */
    async getUserProblemStatsRaw(requestParameters: GetUserProblemStatsRequest, initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<InlineResponse20015>>> {
        if (requestParameters.handle === null || requestParameters.handle === undefined) {
     ...
     * 사용자가 푼 문제 개수 수준별로 가져오기
     */
    async getUserProblemStats(requestParameters: GetUserProblemStatsRequest, initOverrides?: RequestInit): Promise<Array<InlineResponse20015>> {
