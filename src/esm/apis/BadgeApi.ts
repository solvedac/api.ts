...
export class BadgeApi extends runtime.BaseAPI {
     ...
     * 뱃지 정보 가져오기
     */
    async getBadgeRaw(requestParameters: GetBadgeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Badge>> {
     ...
     * 뱃지 정보 가져오기
     */
    async getBadge(requestParameters: GetBadgeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Badge> {
