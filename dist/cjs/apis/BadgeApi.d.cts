...
export declare class BadgeApi extends runtime.BaseAPI {
     ...
     * 뱃지 정보 가져오기
     */
    getBadgeRaw(requestParameters: GetBadgeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Badge>>;
    /**
     * 뱃지의 정보를 가져옵니다.
     * 뱃지 정보 가져오기
     */
    getBadge(requestParameters: GetBadgeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Badge>;
}
