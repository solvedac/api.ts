...
export declare class BackgroundApi extends runtime.BaseAPI {
     ...
     * 배경 정보 가져오기
     */
    getBackgroundRaw(requestParameters: GetBackgroundRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Background>>;
    /**
     * 배경 정보를 가져옵니다.
     * 배경 정보 가져오기
     */
    getBackground(requestParameters: GetBackgroundRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Background>;
}
