...
export declare class OtherApi extends runtime.BaseAPI {
     ...
     * solved.ac 통계 가져오기
     */
    getSiteStatisticsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SiteStatistics>>;
    /**
     * solved.ac 통계를 가져옵니다.
     * solved.ac 통계 가져오기
     */
    getSiteStatistics(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SiteStatistics>;
}
